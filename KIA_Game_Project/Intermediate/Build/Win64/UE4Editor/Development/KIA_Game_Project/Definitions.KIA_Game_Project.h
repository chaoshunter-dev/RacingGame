...
#define UE_PROJECT_NAME KIA_Game_Project
#define UE_TARGET_NAME KIA_Game_ProjectEditor
#define UE_MODULE_NAME "KIA_Game_Project"
...
#define KIA_GAME_PROJECT_API DLLEXPORT
